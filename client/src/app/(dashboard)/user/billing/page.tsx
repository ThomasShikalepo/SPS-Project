...
const UserBilling = () => {
    ...
    useGetTransactionsQuery(user?.id || "", {
       //makes the api call under certain conditions
        skip: !isLoaded || !user //if it isn't loaded and the user does not exist make the api call
        })
...
<SelectContent className="billing_slect-content" >
        ...
        {isLoadingTransactions ? (
            ...
            <Table className="billing__table" >
                <TableHeader className="billing__table-header">
                    <TableRow className="billing__table-header-row"></TableRow>
