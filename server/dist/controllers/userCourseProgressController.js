    ...
    try {
        ...
        if (!progress) {
            ...
            progress = new userCourseProgressModel_1.default({
                ...
                overallProgress: 0,
                sections: (_a = progressData.sections) !== null && _a !== void 0 ? _a : [], // || to ??
                lastAccessedTimestamp: new Date().toISOString(),
            });
        }
        else {
            // Merge existing progress with new progress data
            progress.sections = (0, utils_1.mergeSections)(progress.sections, (_b = progressData.sections) !== null && _b !== void 0 ? _b : [] // || to ??
            );
